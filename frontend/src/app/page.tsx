    ...
    <div className="max-w-6xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mb-16 text-center">
        <h1 className="text-4xl md:text-5xl font-black text-yellow-400 mb-4 tracking-tight">
          Witaj{username ? `, ${username}` : ''} w LAZY TEACHER!
        </h1>
        <p className="text-lg text-slate-400 max-w-2xl mx-auto">
          Twój inteligentny asystent nauki. Zamień dowolne notatki w interaktywny quiz i sprawdzaj swoją wiedzę szybciej niż kiedykolwiek.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl relative overflow-hidden group hover:border-yellow-500/30 transition-colors">
          ...
          <p className="text-slate-400 text-sm">Prześlij swoje notatki, wykłady lub rozdziały z podręcznika w formacie PDF.</p>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl relative overflow-hidden group hover:border-yellow-500/30 transition-colors">
          ...
          <p className="text-slate-400 text-sm">Sztuczna inteligencja wyciąga kluczowe informacje z pliku i automatycznie układa pytania.</p>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl relative overflow-hidden group hover:border-yellow-500/30 transition-colors">
          ...
          <p className="text-slate-400 text-sm">Sprawdź się rozwiązując wygenerowany quiz i od razu zobacz, co już umiesz.</p>
        </div>
