  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <div className="bg-slate-900 rounded-xl border border-slate-800 p-8 shadow-2xl">
        ...
        <p className="text-slate-400 mb-8">Wgraj swoje notatki w formacie PDF, a LazyTeacher wygeneruje dla Ciebie test.</p>
        ...
        <div 
          ...
          `}
        >
          <svg className={`mx-auto h-12 w-12 mb-4 transition-colors ${selectedFile ? 'text-green-500' : 'text-yellow-500/50 group-hover:text-yellow-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            {selectedFile ? (
        ...
        {uploadStatus.message && (
          <div className={`mt-6 p-4 rounded-md text-sm font-medium ${uploadStatus.type === 'success' ? 'bg-green-500/10 text-green-400 border border-green-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'}`}>
            {uploadStatus.message}
          </div>
        )}
