...
class TestQuiz:
    ...
    def test_create_quiz(self, user, document):
        quiz = Quiz.objects.create(
            user=user, document=document, code="TEST123", is_active=True
        )
    ...
    def test_quiz_str(self, user, document):
        quiz = Quiz.objects.create(user=user, document=document, code="QUIZ001")
...
class TestAnswer:
    ...
    def test_answer_str(self, quiz_obj):
        ...
        correct_answer = Answer.objects.create(
            question=question, text="Correct Answer", is_correct=True
        )
        incorrect_answer = Answer.objects.create(
            question=question, text="Incorrect Answer", is_correct=False
        )
    ...
    def test_answer_ordering(self, quiz_obj):
        ...
        answer1 = Answer.objects.create(
            question=question, text="Answer 1", is_correct=False
        )
        answer2 = Answer.objects.create(
            question=question, text="Answer 2", is_correct=True
        )
